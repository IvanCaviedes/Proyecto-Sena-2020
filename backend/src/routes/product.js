...
Router.get('/',ProductCtrl.index) // api.com/product/ Index: Listar todos los productos
      .post('/create',ProductCtrl.create)   // api.com/product/ Create: Crear un nuevo producto
      .get('/cinco',ProductCtrl.cinco) //limitamos los productos a solo 5 
      .get('/buscar',ProductCtrl.FindFEnStock)
